...
func TestResourceParseOk(t *testing.T) {
	cs := []struct {
		...
		{
			Option:   "uri=/admin",
			Resource: &Resource{URL: "/admin", Methods: common.AllHTTPMethods},
		},
		{
			Option:   "uri=/",
			Resource: &Resource{URL: "/", Methods: common.AllHTTPMethods},
		},
		{
			Option:   "uri=/admin/sso|roles=test,test1",
			Resource: &Resource{URL: "/admin/sso", Roles: []string{"test", "test1"}, Methods: common.AllHTTPMethods},
		},
		{
		...
		},
		{
			...
			Resource: &Resource{URL: "/allow_me", WhiteListed: true, Methods: common.AllHTTPMethods},
		},
		{
		...
		},
		{
			...
			Resource: &Resource{URL: "/*", Methods: common.AllHTTPMethods, Groups: []string{"admin", "test"}},
		},
		{
			Option:   "uri=/*|groups=admin",
			Resource: &Resource{URL: "/*", Methods: common.AllHTTPMethods, Groups: []string{"admin"}},
		},
		{
			Option:   "uri=/*|require-any-role=true",
			Resource: &Resource{URL: "/*", Methods: common.AllHTTPMethods, RequireAnyRole: true},
		},
	}
	for i, x := range cs {
